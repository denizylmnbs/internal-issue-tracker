...
/**
 * No live comment with the given id <em>on the given issue</em>. A comment that exists but hangs off
 * a different issue reports as missing rather than forbidden - the caller has no business knowing it
 * is there.
 */
