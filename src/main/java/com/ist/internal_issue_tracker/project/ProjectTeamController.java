...
public class ProjectTeamController {
  ...
  public ResponseEntity<ApiResponse<ProjectTeamResponse>> createProjectTeam(
      @PathVariable Integer id, @Valid @RequestBody ProjectTeamCreateRequest request) {
    ProjectTeamResponse response = projectTeamService.createProjectTeam(id, request);
  ...
  public ResponseEntity<ApiResponse<Void>> removeProjectTeam(
      @PathVariable Integer id, @PathVariable Integer teamId) {
    projectTeamService.removeProjectTeam(id, teamId);
