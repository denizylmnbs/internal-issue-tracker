...
/**
 * Where a project stands in its lifecycle. Persisted as a string, so the constant names must stay
 * in sync with the {@code projects.status} CHECK constraint in the schema - adding a value here
