...
/**
 * No live issue with the given id <em>on the given project</em>. An issue that exists but belongs to
 * a different project reports as missing rather than forbidden: the caller has no business knowing
 * it is there, and a 403 would confirm it.
 */
