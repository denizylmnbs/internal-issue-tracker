...
/**
 * The audited fields of an issue, copied off it before a write so they can be compared with what the
 * write left behind.
 *
 ...
 * forget a field. {@code epicId} is absent for the opposite reason - {@code issue_activities} has no
 * action type for it, so a change there has nowhere to be recorded.
 */
