 ...
 * first ever, for the reason given on {@link UserTeamMembershipResponse} - it is the row's
 * {@code updatedAt}, and joining or leaving is the only thing that writes to one of these rows.
 */
