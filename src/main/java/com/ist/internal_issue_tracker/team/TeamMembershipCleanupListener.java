 ...
 *
 * <p>Plain {@code @EventListener}, and these events stay in the process: anything asynchronous
 * would leave a window in which a deleted team's roster is still being served. The listener runs
 * inline in the publisher's transaction, so the delete and the cleanup commit together or not at
 * all.
 */
@Component
