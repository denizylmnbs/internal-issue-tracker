 ...
 * the union query in {@link ProjectActivityRepository} embeds a single named source of truth, rather
 * than "PROJECT"/"ISSUE"/"SPRINT" typed out separately in SQL and in {@code ActivityMapper}.
 */
