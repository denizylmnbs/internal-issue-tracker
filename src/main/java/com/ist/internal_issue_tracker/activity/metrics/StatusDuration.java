 ...
 *
 * <p>{@code getStatus} is a String rather than {@link MetricStatus}: it is whatever the activity
 * log recorded, and a status that has since been removed from the application still appears in
 * history. Parsing it here would throw on exactly the rows most worth seeing.
 */
