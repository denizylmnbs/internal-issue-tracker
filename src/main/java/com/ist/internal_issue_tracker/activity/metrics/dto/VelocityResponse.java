 ...
 *
 * <p>No {@link MetricWindow}: a sprint is its own window, and the series is every sprint the project
 * has run in the order it ran them. Sprints that have not started yet are included with nulls, which
 * is how a client can chart the plan alongside the history.
 *
 ...
 * started. {@code sayDoRatio} is then null too rather than being invented from the delivered figure,
 * which would make every such sprint look like a perfect hit.
 *
