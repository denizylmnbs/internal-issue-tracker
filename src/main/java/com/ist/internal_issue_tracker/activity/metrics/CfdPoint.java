...
/**
 * How many issues stood in one status at the end of one day - a cumulative flow diagram, one cell at
 * a time.
 *
 ...
 * That is a deliberate difference from the burndown, which shows them leaving: a CFD is read for the
 * shape of its bands rather than for its totals, and an issue that no longer exists distorts the
 * shape more than it informs it.
 */
