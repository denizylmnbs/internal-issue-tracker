 ...
 *
 * <p>The dimension is echoed back for the same reason the window is: the request may have omitted it
 * and taken the default, and a series whose meaning depends on a parameter has to say which one it
 * got.
 *
