 ...
 *
 * <p>Null rather than zero when the window holds no time at all: "nothing happened" and "nothing
 * was worked on" are different claims, and only the second is an indictment.
 */
