 ...
 *
 * <p>The age is measured from the moment the issue entered the status it is in now, so an issue that
 * has been open for a year but was picked up this morning reports as young. That is the intent - the
 * question is how long this piece of work has been stalled where it is, and the whole-life version
 * of it is lead time.
 *
