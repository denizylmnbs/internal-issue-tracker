 ...
 *
 * <p>Unrelated to deletion: a sprint is removed by stamping {@code deletedAt}, never by moving it
 * to a status. {@link #COMPLETED} is a finished sprint, not a gone one.
 */
