...
public enum SprintErrorCode implements ErrorCode {
  ...
  SPRINT_NAME_ALREADY_EXISTS(HttpStatus.CONFLICT, "This project already has a sprint by that name."),
  ...
  SPRINT_ALREADY_IN_PROGRESS(
      HttpStatus.CONFLICT, "This project already has a sprint in progress.");
