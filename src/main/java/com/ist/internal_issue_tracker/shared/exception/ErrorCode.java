...
/**
 * Contract every module-specific error code enum must implement.
 * Keeps {@code shared} free of domain vocabulary: modules depend on this
 * interface, {@code shared} never depends on a module's enum.
 */
