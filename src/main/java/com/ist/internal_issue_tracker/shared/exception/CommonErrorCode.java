...
/**
 * Framework-level / cross-cutting error codes that don't belong to any single
 * business module. Module-specific codes (e.g. {@code SPRINT_ALREADY_IN_PROGRESS})
 * live in their own module as separate {@link ErrorCode} enums.
 */
