 ...
 *
 * <p>{@code DATES} renders both dates at once, as {@code start..end}, with the end left off when
 * the sprint has no end date. One action type covers the pair, so one value has to describe the
 * pair.
 */
