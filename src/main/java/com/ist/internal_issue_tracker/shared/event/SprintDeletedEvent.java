 ...
 * travels with it for the reason given on {@link SprintCreatedEvent}, which also covers the routing
 * key and what may and may not change about this record now that it is on the wire.
 */
