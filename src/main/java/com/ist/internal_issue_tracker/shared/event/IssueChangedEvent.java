 ...
 *
 * <p>{@code dimensions} describes the issue <em>after</em> this change, not before it, and every row
 * the event produces carries the same copy. That is what lets a burndown ask "which sprint was this
 * issue in when it reached DONE" of the DONE row itself - see {@link IssueDimensions}. When the
