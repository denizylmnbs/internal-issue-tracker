...
public interface SprintLookup {
   ...
   * there. This is the seam between the two, and keeping it a read-only projection is what stops
   * the {@code activity} module from acquiring a dependency on {@code sprint} to draw a chart.
   *
